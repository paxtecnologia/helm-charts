...
*/}}
{{- define "ms-java-spring-boot.name" -}}
...
*/}}
{{- define "ms-java-spring-boot.fullname" -}}
...
*/}}
{{- define "ms-java-spring-boot.chart" -}}
...
{{- default (include "ms-java-spring-boot.fullname" .) .Values.serviceAccount.name }}
{{- else }}
